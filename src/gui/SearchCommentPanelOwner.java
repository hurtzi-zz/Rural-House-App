...
public class SearchCommentPanelOwner extends JPanel implements Serializable {
	...
	public SearchCommentPanelOwner(final RuralHouse h, int pag, final Client c) {
		...
		if (orriKopu == 0) {
			if (lekuak == 1) {
				JPanel panel1 = new CommentPanelOwner(h,comments, pag);
				...
				JPanel panel2 = new CommentPanelOwner(h,comments, pag + 1);
				...
				JPanel panel3 = new CommentPanelOwner(h,comments, pag + 2);
