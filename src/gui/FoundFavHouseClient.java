...
public class FoundFavHouseClient extends JPanel implements Serializable{
	...
	public FoundFavHouseClient(final Client c, Vector<RuralHouse> h, int pag) {
		...
		if (orriKopu == 0) {
			if (lekuak == 1) {
				JPanel panel1 = new FoundPanelFavClient(c, h, pag);
				...
				JPanel panel2 = new FoundPanelFavClient(c, h, pag + 1);
				...
				JPanel panel3 = new FoundPanelFavClient(c, h, pag + 2);
